...
$sql=mysqli_query($con,"delete from new_creator where ID=$rid");
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($con,"select * from new_creator");
$cnt=1;
...
<?php } ?>                 
         ...
         <div class="col-sm-7" align="text-align">
